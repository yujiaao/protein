...
const names= {
'evm.model.1.10740':'BRCT3',
'evm.model.1.10808':'BRCT4',
'evm.model.1.3990':'BRCT1',
'evm.model.1.7034':'BRCT2',
'evm.model.2.613':'BRCT5',
'evm.model.3.1134':'BRCT6',
'evm.model.3.1204':'BRCT7',
'evm.model.3.1486':'BRCT8',
'evm.model.3.1541':'BRCT9',
'evm.model.3.1648':'BRCT10',
'evm.model.3.1840':'BRCT11',
'evm.model.3.2233':'BRCT12',
'evm.model.4.1000':'BRCT17',
'evm.model.4.27':'BRCT13',
'evm.model.4.282':'BRCT15',
'evm.model.4.372':'BRCT16',
'evm.model.4.4602':'BRCT18',
'evm.model.4.72':'BRCT14',
'evm.model.6.575':'BRCT19',
'evm.model.8.2802':'BRCT21',
'evm.model.8.777':'BRCT20'
}

function brctNames(alignment) {
    let namesWithNum = [];
    let i = 1;
    alignment.map((item, index) => {
        let key = item[0] 
        let suffix = ''
        if(index<alignment.length-1 &&  key=== alignment[index+1][0]
            || index>2 &&  key=== alignment[index-1][0]){
            suffix =  "_" + (i++)
        ...
        namesWithNum.push( names[key] + suffix)
    })
    return namesWithNum;
}
...
function calcTableData(alignment, brct, cutLength) {
    ...
    alignment.map((item, index) => {
        ...
        data.push({ No: index+1, key: names[key] + suffix, start, end, before, 'brct': brctCut, after, name })
    })
    return data;
}
